...
const ConfirmOrderEmail = (props) => {
  const { order_num, order_date } = props;
  ...
  return (
    <Html>
      <Head />
      <Preview>หมายเลขคำสั่งซื้อ: {order_num}</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          >
            ...
            >
              ยืนยันคำสั่งซื้อหมายเลข: {order_num}
            </Text>
          </Section>

          <Section style={paragraphContent}>
            <Text style={paragraph}>ขอบคุณสำหรับคำสั่งซื้อ</Text>
            <Text style={paragraph}>
              เราได้รับหมายเลขคำสั่งซื้อ {order_num} ของคุณเมื่อ{" "}
              {date.getDate()} {thaiMonthNames[date.getMonth()]}{" "}
              {date.getFullYear() + 543} {date.toTimeString().slice(0, 5)} แล้ว!
            </Text>
            <Text style={paragraph}>
          ...
          {shipping.label !== "รับที่ร้าน" && (
            <Section style={paragraphContent}>
              <Text style={paragraph}>
                หลังจากที่เราจัดส่งสินค้าของท่านเรียบร้อยแล้วเราจะส่งอีเมลยืนยันการจัดส่งอีกทีนึง
              </Text>
            </Section>
          )}
